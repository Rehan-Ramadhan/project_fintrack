                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('saldo.store') }}" method="POST">
                            @csrf
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="nama_e_wallet">Nama E-Wallet</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="total_saldo">Total Saldo</label>
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text">
